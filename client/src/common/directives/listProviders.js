angular.module('14all').directive('listProviders',[function(){
    return {
        ...
        template :  '  <div class="form-group">' +
            '<label for="searchItemTitle" class="control-label">Search</label><div class="input-group"><input class="form-control" id="searchItemTitle" ng-model="initialValue" type="text" />' +
            ...
            '</ul><a class="btn btn-default" ng-click="search(initialValue)">Go</a></div></div></div>',
